      ...
      <div className="px-4 mt-8">
        ...
        <div className="flex flex-col gap-2">
          {leaderboardData.map((player) => (
              <div key={player.rank} className={`border rounded-xl p-3 flex items-center justify-between ${player.rank <= 3 ? 'bg-amber-900/10 border-amber-500/30' : 'bg-[#15151e] border-gray-800'}`}>
